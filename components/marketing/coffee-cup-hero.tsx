  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden
      />
      <div className="pointer-events-none absolute -right-[15vw] -bottom-[7vh] z-[5] flex aspect-square w-[82vw] items-center justify-center sm:w-[62vw] sm:-right-[14vw] sm:-bottom-[16vh] md:-right-[9%] md:w-[50vw]">
